              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" style="background:greenyellow ;color: white"
                     href="{{route('My_Appoinment')}}">My Appoinment</a>
                  </li>
        ...
        <table>
            ...
            @foreach ($appointment as $appointments )
                <tr style="background-color:black; color:white;" align="center">
                    ...
                    <td><a class="btn btn-danger" onclick="return confirm('are you sure to delete this?')" href="{{route('cancel_appointment',$appointments->id)}}">Cancel</a></td>
                </tr>
            @endforeach
